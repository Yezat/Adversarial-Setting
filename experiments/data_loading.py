...
# # TODO make sure this doesn't add computational logic and we get a dataframe ready for plotting out of this immediately...
...
#         df_state_evolution["calibrations"] = df_state_evolution["calibrations"].apply(
#             lambda x: json.loads(x)
#         )
#         df_erm = dbHandler.get_erms()
#         df_erm["analytical_calibrations"] = df_erm["analytical_calibrations"].apply(
#             lambda x: json.loads(x)
#         )
#         df_erm["erm_calibrations"] = df_erm["erm_calibrations"].apply(
#             lambda x: json.loads(x)
#         )
...
#                 exploded[["attack_epsilon", new_column]] = pd.DataFrame(
#                     exploded[column].tolist(), index=exploded.index
#                 )
#             else:
...
#         ]
#         new_columns = [
#             "adversarial_generalization_error",
#             "adversarial_generalization_error_teacher",
#             "adversarial_generalization_error_overlap",
#             "fair_adversarial_error",
#             "test_loss",
#             "boundary_loss_test",
#         ]
...
#             "adversarial_generalization_errors_teacher",
#             "fair_adversarial_errors",
#             "first_term_fair_errors",
#             "second_term_fair_errors",
#             "third_term_fair_errors",
#             "test_losses",
#             "data_model_adversarial_generalization_errors",
#             "gamma_robustness_es",
#             "boundary_loss_test_es",
#         ]
#         new_columns = [
...
#             "test_loss",
#             "data_model_adversarial_generalization_error",
#             "gamma_robustness",
#             "boundary_loss_test",
#         ]  #
#         return explode_measures(df, new_columns, columns)
...
#     df2["sigmax_first_ev"] = df2.apply(
#         lambda row: extract_first_eigenvalue(row, "sigmax_eigenvalues"), axis=1
#     )
#     df2["sigmax_second_ev"] = df2.apply(
#         lambda row: extract_second_eigenvalue(row, "sigmax_eigenvalues"), axis=1
#     )
#     df2["sigmax_trace"] = df2.apply(
...
#         (df_experiments["completed"] == True)
#         & (df_experiments["code_version"] == version_choice)
#     ]
#     df_experiments = df_experiments.sort_values(by="date", ascending=False)

#     df_state_evolution["estimation_error"] = (
#         1 + df_state_evolution["q"] - 2 * df_state_evolution["m"]
#     )
